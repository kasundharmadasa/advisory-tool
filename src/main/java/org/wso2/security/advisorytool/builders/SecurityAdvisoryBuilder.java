...
import org.wso2.security.advisorytool.model.Header;
...
import static org.wso2.security.advisorytool.utils.Constants.AUTHORIZATION_HEADER_NAME;
import static org.wso2.security.advisorytool.utils.Constants.PATCH_LIFECYCLE_STATE;
import static org.wso2.security.advisorytool.utils.Constants.PATCH_LIFECYCLE_RELEASED_STATE;
import static org.wso2.security.advisorytool.utils.Util.getApplicableProductsForAKernel;
...
public abstract class SecurityAdvisoryBuilder {
    ...
    protected Patch getPatchDetails(String patchName) throws AdvisoryToolException {
        ...
        headerList.add(new Header(AUTHORIZATION_HEADER_NAME, Configuration.getInstance()
        ...
        try {
            ...
            for (jsonMainArrayIndex = 0; jsonMainArrayIndex < jsonMainArr.length();
                ...
                if (PATCH_LIFECYCLE_STATE.equals(jsonObjectString)) {
                    ...
                    for (int jsonArrayIndex = 0; jsonArrayIndex < jsonArray.length();
                        ...
                        if (!jsonArray.get(jsonArrayIndex).toString()
                                .contains(PATCH_LIFECYCLE_RELEASED_STATE)) {
                    ...
                    for (int jsonArrayIndex = 0; jsonArrayIndex < jsonArray.length();
                        ...
                        if (!"Carbon".equals(array[0].trim())) {
                            ...
                            applicableProductAndVersionStringList
                                    .addAll(getApplicableProductsForAKernel(array[1].trim()));
                        }
                    }
                }
            }
